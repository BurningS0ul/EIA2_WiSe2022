...
(function (Artpiece) {
    ...
    for (i = 0; i < 20; i++) {
        ...
        let birdie = new Artpiece.Bird(pos, size, getRandomValue("#"), speed);
        birds.push(birdie);
    }
    ...
    Artpiece.getRandomValue = getRandomValue;
    function darkenColor(_color, amount) {
        let r = _color[1] + _color[2];
        let g = _color[3] + _color[4];
        let b = _color[5] + _color[6];
    ...
    Artpiece.darkenColor = darkenColor;
